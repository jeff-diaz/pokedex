...
function Fairy({ color = "white", addColor, height }) {
  return (
    <svg id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
      <g id="Layer_1-2">
        <path
          d="m50,100C40.8,66.67,33.33,59.2,0,50,33.33,40.8,40.8,33.33,50,0c9.2,33.33,16.67,40.8,50,50-33.33,9.2-40.8,16.67-50,50Z"
          style={{
            height: `${height}px`,
